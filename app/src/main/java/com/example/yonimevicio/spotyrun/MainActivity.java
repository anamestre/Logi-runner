...
public class MainActivity extends AppCompatActivity {
                            ...
                            new Connector.ConnectionListener() {
                                ...
                                public void onConnected(SpotifyAppRemote spotifyAppRemote) {
                                    ...
                                    try {
                                        ...
                                        Tracks tr = gson.fromJson(recommended, Tracks.class);
    ...
    private void fullfill_playlist(com.example.yonimevicio.spotyrun.Track[] tracks, String playlistID) throws IOException {
        ArrayList<String> stracks = new ArrayList<>();
        JSONArray jsonArray;


        for (com.example.yonimevicio.spotyrun.Track track : tracks) {
